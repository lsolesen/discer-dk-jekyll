...
$discshoppen = 'https://www.partner-ads.com/dk/feed_udlaes.php?partnerid=28187&bannerid=94579&feedid=2555';

$search = '';

$file = './_data/discshoppen.yml';
unlink($file);
fopen($file, 'a');

write_products($file, $discshoppen);
